...
#
# Usage:
#   bash test_build_shell_nested_authors.sh          # check against goldens
#   bash test_build_shell_nested_authors.sh --regen  # rewrite the golden
#                                                    # files from current
#                                                    # script output
#
...
echo "== build_shell_nested_authors.sh: SQL format (-f sql) =="
...
echo "== build_shell_nested_authors.sh: debug mode (-d ON) =="
